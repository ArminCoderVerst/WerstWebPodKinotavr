...
<head>
    ...
    <title>Errors 404 Template | Kinotavr.by</title>
...
<body>
	<section id="wrapper" class="container-fluid">
		<div class="error-box">
			<div class="error-body text-center pt-5">
				<h1 class="text-danger">404</h1>
				<h3 class="text-light">Страница не найдена !</h3>
				<p class="text-muted mt-3 mb-3">Сайт который вы ищите</p>
				<a href="../html/Index.php" class="btn btn-danger home mb-5">Назад домой =)</a>
			</div>
		</div>
		<footer class="footer text-center text-light container-fluid py-4 mt-5"><?php echo date("Y");?> <a href="../html/Index.php" target="_blank">Kinotavr.by</a></footer>
	</section>
