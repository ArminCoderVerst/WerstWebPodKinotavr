    function fileSelectedNews(){
        var file = $("#img-news").files[0];
        if (file) {
            var fileSize = 0;
    ...
    var name= "";
    function fileUploadNews(){
        var fd = new FormData();
        fd.append("fileuploadnews", document.getElementById('img-news').files[0]);
        console.log();
        ...
        xhr.open("POST", "ajax/uploadFileNews.php");
        xhr.send(fd);
    }
